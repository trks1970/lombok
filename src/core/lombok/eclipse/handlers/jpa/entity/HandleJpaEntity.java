...
public class HandleJpaEntity extends EclipseAnnotationHandler<LombokJpaEntity>
{
	...
	{
		LOG.fine("hanlde<LombokMain> enter");
		...
		LOG.fine("before getInstance");
		LombokJpaEntity a = annotation.getInstance();
		LOG.fine("after getInstance");
		// add ID field
		...
		LOG.fine("before addTableAnnotation");
		addTableAnnotation( ast, a, typeDecl );
		LOG.fine("after addTableAnnotation");
		...
		LOG.fine("hanlde<LombokMain> exit");
	}
